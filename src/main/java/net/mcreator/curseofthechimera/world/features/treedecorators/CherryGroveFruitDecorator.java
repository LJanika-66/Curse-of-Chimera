...
public class CherryGroveFruitDecorator extends CocoaDecorator {
	public static Codec<CherryGroveFruitDecorator> CODEC = Codec.unit(CherryGroveFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("cherry_grove_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public CherryGroveFruitDecorator() {
		super(0.2f);
	}
