...
package net.mcreator.curseofthechimera.world.dimension;
...
public class RealmofChimeraDimension {
	...
	public static class DimensionSpecialEffectsHandler {
		...
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("curse_of_the_chimera:realmof_chimera"), customEffect);
		}
	}
}
