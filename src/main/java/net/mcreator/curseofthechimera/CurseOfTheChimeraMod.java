package net.mcreator.curseofthechimera;
...
@Mod("curse_of_the_chimera")
public class CurseOfTheChimeraMod {
	public static final Logger LOGGER = LogManager.getLogger(CurseOfTheChimeraMod.class);
	public static final String MODID = "curse_of_the_chimera";

	public CurseOfTheChimeraMod() {
